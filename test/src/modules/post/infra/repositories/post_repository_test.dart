...
import 'package:clean_architecture_flutter/src/modules/post/infra/datasources/comment_datasource.dart';
...
import 'package:clean_architecture_flutter/src/modules/post/infra/repositories/post_repository.dart';
import 'package:flutter_test/flutter_test.dart';
import 'package:fpdart/fpdart.dart';
import 'package:mocktail/mocktail.dart';

class UserDataSouceMock extends Mock implements IUserDatasource {}
class PostDataSouceMock extends Mock implements IPostDatasource {}
class CommentDataSouceMock extends Mock implements ICommentDatasource {}

void main() {
  final IUserDatasource userDatasource = UserDataSouceMock();
  final IPostDatasource postDatasource = PostDataSouceMock();
  final ICommentDatasource commentDatasource = CommentDataSouceMock();
